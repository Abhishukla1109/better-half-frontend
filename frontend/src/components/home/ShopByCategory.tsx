...
const CATEGORIES = [
  { key: 'hair', emoji: '💇', label: 'Hair', color: 'bg-[#e8f5f5]', href: '/explore?filter=hair' },
  ...
  { key: 'wellness', emoji: '🌿', label: 'Wellness', color: 'bg-[#e8f5f5]', href: '/explore?filter=wellness' },
  ...
  return (
    <section className="py-10 bg-white">
      <div className="max-w-6xl mx-auto px-4">
        <h2 className="text-xl md:text-2xl font-extrabold text-[#1a2e2e] mb-6">Shop by Category</h2>
